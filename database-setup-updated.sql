...
-- Create collaborator_projects table (for their portfolio)
...
('technologies', 'Technologies I Use', '["React", "Node.js", "TypeScript", "MongoDB", "PostgreSQL", "Next.js", "Express", "Tailwind CSS"]'::jsonb, 4),
...
('cta', 'Have a Project in Mind?', '{"description": "Let''s work together to bring your ideas to life", "buttonText": "Get In Touch"}'::jsonb, 6);
